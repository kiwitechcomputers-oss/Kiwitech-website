...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    date: '8 months ago',
    rating: 5,
    text: 'I am incredibly impressed with the outstanding CCTV service I received from Kiwi Tech Computers. From the very first call, their team was professional, responsive, and highly knowledgeable.',
    tag: 'CCTV Installation',
  },
  {
    name: 'Mothukupally Rathnam',
    initials: 'MR',
    date: '1 month ago',
    rating: 5,
    text: 'Very good experience with Kiwi Tech Computers. Fast service, genuine products available, reasonable price, problems clearly explained and completed the repair on time.',
  ...
  },
  {
    ...
    date: '9 months ago',
    rating: 5,
    text: 'Exceptional service from Kiwi Tech Computers! My printer was fixed in no time. The technician was professional, fast, and very knowledgeable. It’s working perfectly now.',
    tag: 'Printer Repair',
  },
  {
    name: 'Uday Putta',
